...
enum TokenType{IDENTIFIER, NUMBER, OTS, CTS, OT, CT, COMMA, EQ, QUOTEDSTRING, EOF, ERROR}
class Token{
	String text;
	int begin;
	int end;
...
public class Lexer {
	...
	private int yy_cmap[] = unpackFromString(1,130,
			"7:9,10,11,7,10,11,7:18,10,7,6,7:9,1,7:2,4,9:10,7:2,2,5,3,7:2,8:26,7:6,8:26," +
					"7:5,0:2")[0];

	private int yy_rmap[] = unpackFromString(1,16,
			"0,1:2,2,1,3,1,4,5,1:2,6:2,7,6,1")[0];

	private int yy_nxt[][] = unpackFromString(8,12,
			"1,2,3,4,5,6,14,15,7,13,8:2,-1:16,9,-1:10,10,-1:16,7:2,-1:12,8:2,-1,11:5,12," +
					"11:4,-1:10,13,-1:2");
				...
				if (YY_NO_STATE == yy_last_accept_state) {
					...
					switch (yy_last_accept_state) {
						...
						case -6:
							break;
						case 5:
						{ java.lang.System.out.println("Unmatched input: " + yytext() +" "+ yychar); }
						case -7:
							break;
						case 6:
						...
						case -10:
							break;
						case 9:
						{return new Token(TokenType.OTS,yytext(),yychar,yychar+yytext().length());}
						case -11:
							break;
						case 10:
						{return new Token(TokenType.CTS,yytext(),yychar,yychar+yytext().length());}
						case -12:
							break;
						case 12:
